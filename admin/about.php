...
<div class="flex max-w-7xl mx-auto mt-8 px-4 flex-col md:flex-row"> 
  ...
  <main class="w-full md:w-3/4 bg-white dark:bg-gray-800 rounded shadow p-6 md:ml-6"> 
    <div class="flex justify-between items-center mb-4"> 
      ...
      <a href="add_about.php" class="bg-purple-600 text-white px-4 py-2 rounded hover:bg-purple-700 transition">+ Tambah Data</a> 
    </div> 
    ...
    <div class="space-y-4"> 
      ...
      while ($data = mysqli_fetch_array($query)) { 
        ...
        echo "<a href='edit_about.php?id_about={$data['id_about']}' class='text-purple-600 dark:text-purple-400 hover:underline'>Edit</a>"; 
