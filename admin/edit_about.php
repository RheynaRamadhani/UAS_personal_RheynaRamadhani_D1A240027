...
// Validasi ID
$id = isset($_GET['id_about']) ? intval($_GET['id_about']) : 0; 
...
<div class="flex flex-col md:flex-row max-w-7xl mx-auto mt-8 px-4"> 
  ...
  <aside class="w-full md:w-1/4 bg-white dark:bg-gray-800 rounded shadow p-4 mb-6 md:mb-0">
    ...
    <ul class="space-y-2 text-gray-700 dark:text-gray-300">
      ...
      <li><a href="about.php" class="block font-semibold text-purple-800 dark:text-purple-300">👤 About</a></li>
      <li>
    ...
    <form action="proses_edit_about.php" method="post" class="space-y-6">
      ...
      <div>
        ...
        <textarea id="about" name="about" rows="5" required
          class="w-full p-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded focus:outline-none focus:ring focus:border-purple-500"><?php echo htmlspecialchars($data['about']); ?></textarea>
      </div>
