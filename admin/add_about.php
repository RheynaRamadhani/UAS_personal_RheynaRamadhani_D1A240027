      ...
      <form action="proses_add_about.php" method="post" class="space-y-6"> 
        <div> 
          ...
          <textarea id="about" name="about" rows="5" required 
            class="w-full p-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded focus:outline-none focus:ring focus:border-purple-500"></textarea> 
        </div> 
